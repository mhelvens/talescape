...
//  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	angular.module('TS').directive('tsSourceEditor', ['$location', function ($location) { //////////////////////////////
//  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//      ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			link: function (scope, element, attrs, controller) {
				controller.map().then(function (map) {
					...
					scope.buttonIcon = function (mode) {
						return MODE_ICONS[mode][mode == scope.mode];
					};
					...
					function _startTheDrawingProcess() {
						...
						function drawReach() {
							...
							map.setOptions({ draggableCursor: "url(//maps.gstatic.com/mapfiles/crosshair.cur) 7 7, crosshair" });
							...
							//
							listeners.push(gmaps.event.addListener(map, 'mousemove', function (mouseEvent) {
							...
							//
							listeners.push(gmaps.event.addListenerOnce(map, 'click', function (mouseEvent) {
								var distance = gmaps.geometry.spherical.computeDistanceBetween(newSource.radius.getCenter(), mouseEvent.latLng);
								mouseEvent.stop();
						...
						function drawPath(secondPoint) {
							...
							//
							listeners.push(gmaps.event.addListener(map, 'click', function (mouseEvent) {
								newSource.path.getPath().push(mouseEvent.latLng);
							}));

							//// Remove the last segment of the path on a right-click
							//
							listeners.push(gmaps.event.addListener(map, 'rightclick', function (mouseEvent) {
								mouseEvent.stop();
							...
							//
							listeners.push(gmaps.event.addListener(map, 'dblclick', function (mouseEvent) {
								mouseEvent.stop();
