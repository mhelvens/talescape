...
(function (W, O, s) {
	...
	function qb(b, a) {
		...
		return!E(a) || a instanceof RegExp ? a : c.length ? function () {return arguments.length ? a.apply(b, c.concat(ta.call(arguments, 0))) : a.apply(b, c)} : function () {return arguments.length ? a.apply(b, arguments) : a.call(b)}
	}
	...
	function ga(b) {
		...
		try {return 3 === b[0].nodeType ? u(c) : c.match(/^(<[^>]+>)/)[1].replace(/^<([\w\-]+)/, function (a, b) {return"<" + u(b)})} catch (d) {return u(c)}
	}
	...
	function Wb(b) {
		var a = [];
		p(b, function (b, d) {K(b) ? p(b, function (b) {a.push(ua(d, !0) + (!0 === b ? "" : "=" + ua(b, !0)))}) : a.push(ua(d, !0) + (!0 === b ? "" : "=" + ua(b, !0)))});
	...
	function Oa(b) {return b.replace(Uc,function (a, b, d, e) {return e ? d.toUpperCase() : d}).replace(Vc, "Moz$1")}

	function vb(b, a, c, d) {
		function e(b) {
			var e = c && b ? [this.filter(b)] : [this], m = a, k, l, n, r, q, z;
			if (!d || null != b)for (; e.length;)for (k = e.shift(), l = 0, n = k.length; l < n; l++)for (r = x(k[l]), m ? r.triggerHandler("$destroy") : m = !m, q = 0, r = (z = r.children()).length; q <
			                                                                                                                                                                                            r; q++)e.push(Ca(z[q]));
	...
	function ec(b) {
		...
		"function" == typeof b ? (a = b.$inject) || (a = [], b.length && (c = b.toString().replace(Yc, ""), c = c.match(Zc),
				p(c[1].split($c), function (b) {b.replace(ad, function (b, c, d) {a.push(d)})})), b.$inject = a) : K(b) ? (c = b.length - 1, Na(b[c], "fn"), a = b.slice(0, c)) : Na(b, "fn", !0);
		return a
	}

	function Yb(b) {
		function a(a) {return function (b, c) {if (U(b))p(b, Pb(a)); else return a(b, c)}}
		...
		function f(a, b) {
			function c(d) {
				...
				try {return m.unshift(d), a[d] = g, a[d] = b(d)} finally {m.shift()}
			}
		...
		var g = {}, h = "Provider", m = [], k = new Ra, l = {$provide: {provider: a(c), factory: a(d),
			service                                                             : a(function (a, b) {return d(a, ["$injector", function (a) {return a.instantiate(b)}])}), value: a(function (a, b) {return d(a, ca(b))}), constant: a(function (a, b) {
				va(a, "constant");
				l[a] = b;
				r[a] = b
			...
			}}}, n = l.$injector = f(l, function () {throw Sa("unpr", m.join(" <- "));}), r = {}, q = r.$injector = f(r, function (a) {
			a = n.get(a + h);
	...
	function cd(b, a, c, d) {
		...
		h.url = function (a, c) {
			...
			if (a) {if (B != a)return B = a, d.history ? c ? l.replaceState(null, "", a) : (l.pushState(null, "", a), G.attr("href", G.attr("href"))) : (t = a, c ? k.replace(a) : k.href = a), h} else return t || k.href.replace(/%27/g, "'")
		};
		var ha = [], Z = !1;
		...
		h.cookies = function (a, b) {
			var d, e, f, h;
			if (a)b === s ? m.cookie = escape(a) + "=;path=" + ba + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : D(b) && (d = (m.cookie = escape(a) + "=" + escape(b) + ";path=" + ba).length + 1, 4096 < d && c.warn("Cookie '" + a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!")); else {
		...
		this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$http", "$templateCache", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", function (b, l, n, r, q, z, J, Q, v, B, G) {
			...
			function X(a, b, c, f, h) {
				...
				switch (a.nodeType) {
					...
					case 3:
						...
						break;
					case 8:
						try {if (k = d.exec(a.nodeValue))q = ma(k[1]), ia(b, q, "M", f, h) && (c[q] = aa(k[2]))} catch (p) {}
				}
				b.sort(w);
				return b
			}
			...
			function wa(a, b, c, d, e, f, h, g, k) {
				...
				function B(a, d, e, f, k) {
					...
					if (v) {
						...
						p(v.scope, function (a, b) {
							var c = a.match(S) ||
							        [], e = c[3] || b, f = "?" == c[2], c = c[1], h, k, g;
							I.$$isolateBindings[b] = c + e;
							switch (c) {
								case "@":
									t.$observe(e, function (a) {I[b] = a});
					...
					Z && p(Z, function (a) {
						var b =
						{$scope: a === v || a.$$isolateScope ? I : d, $element: da, $attrs: t, $transclude: X}, c;
						ba = a.controller;
						"@" == ba && (ba = t[a.name]);
						c = J(ba, b);
						P[a.name] = c;
					...
					f = 0;
					for (Q = h.length; f < Q; f++)try {G = h[f], G(G.isolateScope ? I : d, da, t, G.require && r(G.require, da, P), X)} catch (M) {n(M, ga(da))}
					f = d;
				...
				for (var wa = !1, ia = !1, V = c.$$element = x(b), H, w, M, u = d, A, F = 0, L = a.length; F < L; F++) {
					...
					if (H.template)if (y("template", Y, H, V), Y = H, M = E(H.template) ? H.template(V, c) : H.template, M = hc(M), H.replace) {
						f = H;
					...
					if (H.templateUrl)y("template", Y, H, V), Y = H, H.replace && (f = H), B = C(a.splice(F, a.length - F), V, c, e, u, h, g, {controllerDirectives: Z, newIsolateScopeDirective: v, templateDirective: Y, nonTlbTranscludeDirective: k}), L = a.length; else if (H.compile)try {A = H.compile(V, c, u), E(A) ? q(null, A, N, fb) : A && q(A.pre, A.post, N, fb)} catch (W) {n(W, ga(V))}
			...
			function S(a) {for (var b = 0, c = a.length; b < c; b++)a[b] = Rb(a[b], {$$isolateScope: !0})}
			...
			function ia(d, e, f, h, g, l, q) {
				...
				if (a.hasOwnProperty(e)) {
					var r;
					e = b.get(e + c);
					for (var z = 0, t = e.length; z < t; z++)try {r = e[z], (h === s || h > r.priority) && -1 != r.restrict.indexOf(f) && (l && (r = Rb(r, {$$start: l, $$end: q})), d.push(r), g = r)} catch (J) {n(J)}
				}
				return g
			}
			...
			function T(a, b) {return A(function () {return a.apply(null, arguments)}, a, b)}
			...
			Db.prototype = {$normalize: ma, $addClass: function (a) {a && 0 < a.length && G.addClass(this.$$element, a)}, $removeClass: function (a) {a && 0 < a.length && G.removeClass(this.$$element, a)}, $set: function (a, b, c, d) {
				...
				var c = this, d = c.$$observers ||
				                  (c.$$observers = {}), e = d[a] || (d[a] = []);
				e.push(b);
				Q.$evalAsync(function () {e.$$inter || b(c[a])});
				return b
			}};
			var M = l.startSymbol(), V = l.endSymbol(), hc = "{{" == M || "}}" == V ? Aa : function (a) {return a.replace(/\{\{/g, M).replace(/}}/g, V)}, Eb = /^ngAttr[A-Z]/;
			return t
		}]
	}
		...
		this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (a, b, c, d, n, r) {
			function q(a) {
				...
				g.success = function (a) {
					g.then(function (b) {a(b.data, b.status, b.headers, d)});
					return g
				};
				g.error = function (a) {
					g.then(null,
							function (b) {a(b.data, b.status, b.headers, d)});
					return g
				};
				return g
			}
			...
			q.pendingRequests = [];
			(function (a) {p(arguments, function (a) {q[a] = function (b, c) {return q(A(c || {}, {method: a, url: b}))}})})("get", "delete", "head", "jsonp");
			(function (a) {p(arguments, function (a) {q[a] = function (b, c, d) {return q(A(d || {}, {method: a, url: b, data: c}))}})})("post", "put");
			q.defaults = e;
			return q
		}]
	}
	...
	function md(b, a, c, d, e, f) {
		function g(a, b) {
			...
			c.src = a;
			N ? c.onreadystatechange = function () {/loaded|complete/.test(c.readyState) && d()} : c.onload = c.onerror = d;
	...
	function sc(b, a, c, d, e, f, g) {
		...
		return g.unwrapPromises ? function (h, g) {
			...
			(k = k[b]) && k.then && (qa(f), "$$v"in k || (l = k, l.$$v =
			                                                     s, l.then(function (a) {l.$$v = a})), k = k.$$v);
	...
	function wd(b, a) {
		...
		var e = function () {
			...
			return k = {resolve: function (a) {
			...
			}, reject          : function (a) {k.resolve(g(a))}, notify: function (a) {
				if (h) {
					var c = h;
					h.length && b(function () {for (var b, d = 0, e = c.length; d < e; d++)b = c[d], b[2](a)})
				}
			}, promise         : {then: function (b, f, g) {
				var k = e(), z = function (d) {try {k.resolve((E(b) ? b : c)(d))} catch (e) {k.reject(e), a(e)}}, J = function (b) {try {k.resolve((E(f) ? f : d)(b))} catch (c) {k.reject(c), a(c)}}, p = function (b) {try {k.notify((E(g) ? g : c)(b))} catch (d) {a(d)}};
				...
				function d(e, f) {
					...
					return h && E(h.then) ? h.then(function () {return b(e, f)}, function (a) {return b(a, !1)}) : b(e, f)
				}
		...
		return{defer: e, reject: g, when: function (h, m, k, l) {
			var n = e(), r, q = function (b) {try {return(E(m) ? m : c)(b)} catch (d) {return a(d), g(d)}}, z = function (b) {try {return(E(k) ? k : d)(b)} catch (c) {return a(c), g(c)}}, p = function (b) {try {return(E(l) ? l : c)(b)} catch (d) {a(d)}};
			b(function () {f(h).then(function (a) {r || (r = !0, n.resolve(f(a).then(q, z, p)))}, function (a) {r || (r = !0, n.resolve(z(a)))}, function (a) {r || n.notify(p(a))})});
			return n.promise
		}, all      : function (a) {
			var b = e(), c = 0, d = K(a) ?
			                        [] : {};
		...
		this.$get = ["$injector", "$exceptionHandler", "$parse", "$browser", function (c, d, e, f) {
			...
			g.prototype = {constructor: g, $new: function (a) {
				...
				return this.$watch(function () {
					f = g(c);
					var a, b;
					if (U(f))if (ob(f))for (d !== k && (d = k, m = d.length = 0, h++), a = f.length, m !== a && (h++, d.length = m = a), b = 0; b < a; b++)d[b] !== f[b] && (h++, d[b] = f[b]); else {
						d !== l && (d = l = {}, m = 0, h++);
						a = 0;
				...
				do {
					B = !1;
					for (t = this; m.length;)try {X = m.shift(), X.scope.$eval(X.expression)} catch (ba) {d(ba)}
					do {
				...
				for (l.$$phase = null; p.length;)try {p.shift()()} catch (y) {d(y)}
			}, $destroy               : function () {
			...
			}, $eval                  : function (a, b) {return e(a)(this, b)}, $evalAsync: function (a) {
				l.$$phase || l.$$asyncQueue.length || f.defer(function () {l.$$asyncQueue.length && l.$digest()});
				...
				$$postDigest          : function (a) {this.$$postDigestQueue.push(a)}, $apply: function (a) {
					try {return h("$apply"), this.$eval(a)} catch (b) {d(b)} finally {
						l.$$phase = null;
						try {l.$digest()} catch (c) {throw d(c), c;}
					}
				}, $on                : function (a, b) {
					...
					do {
						...
						g.currentScope = f;
						l = 0;
						for (m = e.length; l < m; l++)if (e[l])try {e[l].apply(null, k)} catch (p) {d(p)} else e.splice(l, 1), l--, m--;
						if (h)break;
						f = f.$parent
					} while (f);
					return g
				}, $broadcast         : function (a, b) {
					var c = this, e = this, f = {name: a, targetScope: this, preventDefault: function () {f.defaultPrevented = !0}, defaultPrevented: !1}, h = [f].concat(ta.call(arguments, 1)), g, k;
					do {
						c = e;
						f.currentScope = c;
						e = c.$$listeners[a] || [];
						g = 0;
						for (k = e.length; g < k; g++)if (e[g])try {e[g].apply(null, h)} catch (l) {d(l)} else e.splice(g,
								1), g--, k--;
		...
		this.$get = ["$log", "$document", "$injector", function (c, d, e) {
			...
			return{trustAs: function (a, b) {
				...
				if (c === ea.RESOURCE_URL) {
					...
					if (p)for (f = 0, h = a.length; f < h; f++)if ("self" === a[f] ? Fb(e) : a[f].exec(e.href)) {
						p = !1;
						break
					}
					if (p)return d;
	...
	function Cd() {
		this.$get = ["$rootScope", "$browser", "$q", "$exceptionHandler", function (b, a, c, d) {
			function e(e, h, m) {
				...
				h = a.defer(function () {
					try {k.resolve(e())} catch (a) {k.reject(a), d(a)} finally {delete f[l.$$timeoutId]}
					n || b.$apply()
				}, h);
				l.$$timeoutId = h;
				f[h] = k;
	...
	function Ed() {
		return function (b, a, c) {
			...
			"function" !== d &&
			(c = "boolean" === d && c ? function (a, b) {return ab.equals(a, b)} : function (a, b) {
				b = ("" + b).toLowerCase();
	...
	function Cc(b) {
		return function (a, c, d) {
			function e(a, b) {return Ma(b) ? function (b, c) {return a(c, b)} : a}
	...
	function Fc(b, a) {
		...
		d.$setValidity = function (a, b, h) {
			var n = g[a];
			if (b)n && (Ka(n,
					h), n.length || (f--, f || (c(b), d.$valid = !0, d.$invalid = !1), g[a] = !1, c(!0, a), e.$setValidity(a, !0, d))); else {
				f || c(b);
				if (n) {if (-1 != $a(n, h))return} else g[a] = n = [], f++, c(!1, a), e.$setValidity(a, !1, d);
				n.push(h);
				d.$valid = !1;
				d.$invalid = !0
			}
	...
	function nb(b, a, c, d, e, f) {
		...
		k && ((e = k.match(/^\/(.*)\/([gim]*)$/)) ? (k = RegExp(e[1], e[2]), e = function (a) {return l(k, a)}) : e = function (c) {
			var d = b.$eval(k);
	...
	var u = function (b) {return D(b) ? b.toLowerCase() : b}, Ga = function (b) {return D(b) ? b.toUpperCase() : b}, N, x, Ca, ta = [].slice, Md = [].push, Ya = Object.prototype.toString, La = F("ng"), ab = W.angular || (W.angular = {}), Ta, Fa, ka = ["0", "0", "0"];
	N = R((/msie (\d+)/.exec(u(navigator.userAgent)) || [])[1]);
	isNaN(N) && (N = R((/trident\/.*; rv:(\d+)/.exec(u(navigator.userAgent)) || [])[1]));
	w.$inject = [];
	Aa.$inject = [];
	var aa = function () {return String.prototype.trim ? function (b) {return D(b) ? b.trim() : b} : function (b) {return D(b) ? b.replace(/^\s*/, "").replace(/\s*$/, "") : b}}();
	Fa = 9 > N ? function (b) {
		b = b.nodeName ? b : b[0];
	...
	var Sc = /[A-Z]/g, Nd = {full: "1.2.1", major: 1, minor: 2, dot: 1, codeName: "underscore-empathy"}, Qa = L.cache = {}, cb = L.expando = "ng-" + (new Date).getTime(), Wc =
			1, Gc = W.document.addEventListener ? function (b, a, c) {b.addEventListener(a, c, !1)} : function (b, a, c) {b.attachEvent("on" + a, c)}, zb = W.document.removeEventListener ? function (b, a, c) {b.removeEventListener(a, c, !1)} : function (b, a, c) {b.detachEvent("on" + a, c)}, Uc = /([\:\-\_]+(.))/g, Vc = /^moz([A-Z])/, wb = F("jqLite"), Ea = L.prototype = {ready: function (b) {
		function a() {c || (c = !0, b())}
		...
		return"[" + b.join(", ") + "]"
	}, eq                                                                                                                                                                                                                                                                                                                                                                                   : function (b) {return 0 <= b ? x(this[b]) : x(this[this.length + b])}, length: 0, push: Md, sort: [].sort, splice: [].splice}, eb = {};
	...
	p({data      : ac, inheritedData: db, scope: function (b) {return x(b).data("$scope") || db(b.parentNode || b, ["$isolateScope", "$scope"])}, isolateScope: function (b) {
		return x(b).data("$isolateScope") ||
		       x(b).data("$isolateScopeNoTemplate")
	}, controller: bc, injector: function (b) {return db(b, "$injector")}, removeAttr: function (b, a) {b.removeAttribute(a)}, hasClass: Ab, css: function (b, a, c) {
		a = Oa(a);
		...
		var d = u(a);
		if (eb[d])if (C(c))c ? (b[a] = !0, b.setAttribute(a, d)) : (b[a] = !1, b.removeAttribute(d)); else return b[a] || (b.attributes.getNamedItem(a) || w).specified ?
		                                                                                                          d : s; else if (C(c))b.setAttribute(a, c); else if (b.getAttribute)return b = b.getAttribute(a, 2), null === b ? s : b
	}, prop      : function (b, a, c) {if (C(c))b[a] = c; else return b[a]}, text: function () {
		function b(b, d) {
			var e = a[b.nodeType];
			if (y(d))return e ? b[e] : "";
			b[e] = d
	...
	p({removeData  : Zb, dealoc: Pa,
		on         : function a(c, d, e, f) {
			...
			return c
		}, contents: function (a) {return a.childNodes || []}, append: function (a, c) {
			p(new L(c),
			...
			return a
		}, find    : function (a, c) {return a.getElementsByTagName(c)}, clone: yb, triggerHandler: function (a, c, d) {
			c = (la(a, "events") || {})[c];
			d = d || [];
			var e = [
	...
	Ra.prototype = {put: function (a, c) {this[Da(a)] = c}, get: function (a) {return this[Da(a)]}, remove: function (a) {
		var c = this[a = Da(a)];
		delete this[a];
		return c
	}};
	var Zc = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, $c = /,/, ad = /^\s*(_?)(\S+?)\1\s*$/, Yc = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg, Sa = F("$injector"), Od = F("$animate"), Pd = ["$provide", function (a) {
		...
		this.$get = ["$timeout", function (a) {
			return{enter  : function (d, e, f, g) {
				...
				d.remove();
				e && a(e, 0, !1)
			}, move       : function (a, c, f, g) {this.enter(a, c, f, g)}, addClass: function (d, e, f) {
				e = D(e) ? e : K(e) ? e.join(" ") : "";
				p(d, function (a) {
					Cb(a,
							e)
	...
	var gd = /^(x[\:\-_]|data[\:\-_])/i, nd = W.XMLHttpRequest || function () {
			...
			rd = {http: 80, https: 443, ftp: 21}, Hb = F("$location");
	qc.prototype = Ib.prototype = pc.prototype = {$$html5: !1, $$replace: !1, absUrl: gb("$$absUrl"), url: function (a, c) {
		...
		this.hash(d[5] || "", c);
		return this
	}, protocol                                          : gb("$$protocol"), host: gb("$$host"), port: gb("$$port"), path: rc("$$path", function (a) {return"/" == a.charAt(0) ? a : "/" + a}), search: function (a, c) {
	...
	var ya = F("$parse"), uc = {}, qa, Ia = {"null": function () {return null}, "true": function () {return!0}, "false": function () {return!1}, undefined: w, "+": function (a, c, d, e) {
		d = d(a, c);
		e = e(a, c);
	...
	Kb.prototype = {constructor: Kb, lex: function (a) {
		...
		throwError             : function (a, c, d) {
			...
			if (Ia.hasOwnProperty(c))d.fn = Ia[c], d.json = Ia[c]; else {
				...
				d.fn = A(function (a, c) {return m(a, c)}, {assign: function (d, e) {return hb(d, c, e, a.text, a.options)}})
			}
			this.tokens.push(d);
			...
			for (var d = "", e = a, f = !1; this.index < this.text.length;) {
				...
				if (f)"u" === g ? (g = this.text.substring(this.index +
				                                           1, this.index + 5), g.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + g + "]"), this.index += 4, d += String.fromCharCode(parseInt(g, 16))) : d = (f = Rd[g]) ? d + f : d + g, f = !1; else if ("\\" === g)f = !0; else {
					if (g === a) {
						this.index++;
	...
	Wa.prototype = {constructor: Wa, parse: function (a, c) {
		...
		return!1
	}, expect                  : function (a, c, d, e) {return(a = this.peek(a, c, d, e)) ? (this.json && !a.json && this.throwError("is not valid json", a), this.tokens.shift(), a) : !1}, consume: function (a) {this.expect(a) || this.throwError("is unexpected, expecting [" + a + "]", this.peek())}, unaryFn: function (a, c) {
		return A(function (d, e) {
			return a(d,
					e, c)
		}, {constant: c.constant})
	}, ternaryFn               : function (a, c, d) {return A(function (e, f) {return a(e, f) ? c(e, f) : d(e, f)}, {constant: a.constant && c.constant && d.constant})}, binaryFn: function (a, c, d) {return A(function (e, f) {return c(e, f, a, d)}, {constant: a.constant && d.constant})}, statements: function () {
		...
		return A(function (c, d, h) {return e(h || a(c, d), d)}, {assign: function (e, g, h) {return hb(a(e, h), d, g, c.text, c.options)}})
		...
		return A(function (e, f) {
			...
			if (!g)return s;
			(g = Va(g[h], c.text)) && (g.then && c.options.unwrapPromises) && (m = g, "$$v"in g || (m.$$v = s, m.then(function (a) {m.$$v = a})), g = g.$$v);
			return g
	...
	var Hc = function (a) {
			...
			kb = "ng-valid", jb = "ng-invalid", Ha = "ng-pristine", mb = "ng-dirty", Yd = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", function (a, c, d, e, f) {
				...
				this.$setViewValue = function (d) {
					...
					this.$modelValue !== d && (this.$modelValue = d, m(a, d), p(this.$viewChangeListeners, function (a) {try {a()} catch (d) {c(d)}}))
				};
				var r = this;
				a.$watch(function () {
					var c = h(a);
			...
			}, $d = ca({require: "ngModel", link: function (a, c, d, e) {e.$viewChangeListeners.push(function () {a.$eval(d.ngChange)})}}), Kc = function () {
				return{require: "?ngModel", link: function (a, c, d, e) {
					if (e) {
						d.required = !0;
						var f = function (a) {if (d.required && e.$isEmpty(a))e.$setValidity("required", !1); else return e.$setValidity("required", !0), a};
						e.$formatters.push(f);
						e.$parsers.unshift(f);
			...
			ae = function () {
				...
				return{priority: 100, compile: function (a, c) {
					return be.test(c.ngValue) ? function (a, c, f) {f.$set("value", a.$eval(f.ngValue))} : function (a, c, f) {a.$watch(f.ngValue, function (a) {f.$set("value", a)})}
				}}
			...
			}}), ke = [function () {return{scope: !0, controller: "@"}}], Lc = {};
	...
	var le = ["$animate", function (a) {
			...
			return{restrict: "ECA", priority: 400, terminal: !0, transclude: "element", compile: function (h, m) {
				...
				return function (h, m, p, s, x) {
					...
					h.$watch(g.parseAsResourceUrl(k), function (g) {
						var k = function () {!C(n) || n && !h.$eval(n) || d()}, p = ++v;
		...
		return{transclude: "element", priority: 1E3, terminal: !0, $$tlb: !0, link: function (e, f, g, h, m) {
			...
			(l = l[4]) ? (n = a(l), r = function (a, c, d) {
				...
				v.$index = d;
				return n(e, v)
			}) : (q = function (a, c) {return Da(c)}, s = function (a) {return a});
			l = g.match(/^(?:([\$\w]+)|\(([\$\w]+)\s*,\s*([\$\w]+)\))$/);
			...
			e.$watchCollection(h, function (a) {
				...
				y = A.length;
				h = F.length = A.length;
				for (g = 0; g < h; g++)if (D = a === A ? g : A[g], S = a[D], S = n(D, S, g), va(S, "`track by` id"), B.hasOwnProperty(S))u = B[S], delete B[S], v[S] = u, F[g] = u; else {
					if (v.hasOwnProperty(S))throw p(F, function (a) {a && a.startNode && (B[a.id] = a)}), d("dupes", k, S);
					F[g] = {id: S};
					v[S] = !1
				}
				for (D in B)B.hasOwnProperty(D) && (u = B[D], g = ub(u), c.leave(g), p(g, function (a) {a.$$NG_REMOVED = !0}), u.scope.$destroy());
				g = 0;
	...
	}], se = ["$animate", function (a) {return function (c, d, e) {c.$watch(e.ngHide, function (c) {a[Ma(c) ? "addClass" : "removeClass"](d, "ng-hide")})}}], te = sa(function (a, c, d) {
		a.$watch(d.ngStyle, function (a, d) {
			d && a !== d && p(d, function (a, d) {c.css(d, "")});
			a && c.css(a)
		}, !0)
	...
	}}), ye = ["$templateCache", function (a) {return{restrict: "E", terminal: !0, compile: function (c, d) {"text/ng-template" == d.type && a.put(d.id, c[0].text)}}}], ze = F("ngOptions"), Ae = ca({terminal: !0}), Be = ["$compile", "$parse",
	                                                                                                                                                                                                                         function (a, c) {
		                                                                                                                                                                                                                         ...
		                                                                                                                                                                                                                         return{restrict: "E", require: ["select", "?ngModel"], controller: ["$element", "$scope", "$attrs", function (a, c, d) {
				                                                                                                                                                                                                                         ...
				                                                                                                                                                                                                                         function h() {
					                                                                                                                                                                                                                         ...
					                                                                                                                                                                                                                         for (A = c.length; y < A; y++) {
						                                                                                                                                                                                                                         ...
						                                                                                                                                                                                                                         for (F = k.length; I < F; I++)s = k[I], (d = x[I + 1]) ? (E = d.element, d.label !== s.label && E.text(d.label = s.label), d.id !== s.id && E.val(d.id = s.id), E[0].selected !== s.selected && E.prop("selected", d.selected = s.selected)) : ("" === s.id && w ? J =
						                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            w : (J = B.clone()).val(s.id).attr("selected", s.selected).text(s.label), x.push({element: J, label: s.label, id: s.id, selected: s.selected}), E ? E.after(J) : u.element.append(J), E = J);
				                                                                                                                                                                                                                         ...
				                                                                                                                                                                                                                         f.on("change",
						                                                                                                                                                                                                                         function () {
							                                                                                                                                                                                                                         e.$apply(function () {
								                                                                                                                                                                                                                         ...
								                                                                                                                                                                                                                         if (z)for (k = [], p = 0, x = v.length; p < x; p++)for (a = v[p], l = 1, u = a.length; l < u; l++) {
								                                                                                                                                                                                                                         ...
								                                                                                                                                                                                                                         } else if (h = f.val(), "?" == h)k = s; else if ("" === h)k = null; else if (t)for (w = 0; w < c.length; w++) {
									                                                                                                                                                                                                                         if (d[m] = c[w], t(e, d) == h) {
										                                                                                                                                                                                                                         k = q(e, d);
										                                                                                                                                                                                                                         break
									                                                                                                                                                                                                                         }
			                                                                                                                                                                                                                         ...
			                                                                                                                                                                                                                         if (m[1]) {
				                                                                                                                                                                                                                         var r = m[0],
						                                                                                                                                                                                                                         q = m[1], z = h.multiple, u = h.ngOptions, w = !1, v, B = x(O.createElement("option")), D = x(O.createElement("optgroup")), t = B.clone();
				                                                                                                                                                                                                                         m = 0;
	...
	(Ca = W.jQuery) ? (x =
	                   Ca, A(Ca.fn, {scope: Ea.scope, isolateScope: Ea.isolateScope, controller: Ea.controller, injector: Ea.injector, inheritedData: Ea.inheritedData}), vb("remove", !0, !0, !1), vb("empty", !1, !1, !1), vb("html", !1, !1, !0)) : x = L;
	ab.element = x;
	(function (a) {
		A(a, {bootstrap: Xb, copy: fa, extend: A, equals: Ba, element: x, forEach: p, injector: Yb, noop: w, bind: qb, toJson: oa, fromJson: Tb, identity: Aa, isUndefined: y, isDefined: C, isString: D, isFunction: E, isObject: U, isNumber: pb, isElement: Nc, isArray: K, version: Nd, isDate: Ja, lowercase: u, uppercase: Ga, callbacks: {counter: 0},
			$$minErr   : F, $$csp: Sb});
		Ta = Tc(W);
		try {Ta("ngLocale")} catch (c) {Ta("ngLocale", []).provider("$locale", qd)}
